terraform {
  ...
  backend "s3" {
    ...
    key            = "952133486861/StateImportTest/main.tfstate"
    region         = "us-east-1"
...
data "aws_iam_policy_document" "aws_s3_bucket_policy_wp_media_st_StateImportTest_doc" {
  statement {
...
resource "aws_s3_bucket_policy" "aws_s3_bucket_policy_wp_media_st_StateImportTest" {
  bucket                            = aws_s3_bucket.wp_media.id
  policy                            = data.aws_iam_policy_document.aws_s3_bucket_policy_wp_media_st_StateImportTest_doc.json
}
